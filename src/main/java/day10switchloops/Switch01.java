...
public class Switch01 {
    public static void main(String[] args) {
        ...
        System.out.println("Baslangic ayının kacinci ay oldugunu giriniz...");
        ...
        switch (numOfMonth){
            ...
            case 12:
                ...
                break;
            default:
                System.out.println("Gecerli ay numarasini veriniz..");

        }
        /*Note : "switch"de i)String ii)int iii)byte iv)short v) char kullanılabilir
