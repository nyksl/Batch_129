...
public class Animal {
    /*
    1)Parent Classaki method'u Child Class icinde ozellestirerek kullanmaya "Overriding" yapmak denir
    ...
    5)"private" method'lar "overriding" edilemez
    6)Child Class'daki override edilmis method(Overriding Method)'un
      access modifier'i Parent Class'daki override
   ...
   17) Method Overloading "static Polymorphism" dir, Method Overriding "dynamic Polymorphism" dir.
    ...
    public void eat(){//Parent'daki override edilmis eat() method'una "Override Method" denir,
