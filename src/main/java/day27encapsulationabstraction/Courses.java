...
public abstract class Courses {
    /*
    1) Bazen method body'sini yazmak gerekmez bu durumlarda body'siz meyhod olusturmak gerekir.
    ...
    bu yüzden eger bir fonksiyonun child class'lar tarfindan kullanilmasini mecbur kilmak isterseniz
    o method'u abstrac yapmak gerekir

    3)Bir method'un body'sini silmek o method'un abstract olmasi icin yeterli degildir
    "access modifier" ile "return type" arasna "abstract" keyword koymak gerekir.
    ...
    //Ama "Abstract Class" lar icin Child Class olmalidir, cunku Child Class'lar abstract parent class'daki
    // abstarct method'lari kullanirlar.
