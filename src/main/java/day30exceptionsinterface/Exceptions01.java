...
public class Exceptions01 {
    /*
    1)Excaption olsada olmasa'da calistirmamiz gereken kod'lari "finally block" icine yazariz.
    2)DB ile baglantiyi kesme isini yapan kod'lar her halukarda calistirilmalidir, Bu tarz
    ...
    */
    ...
    private static void m(int[] c, int a, int b){
